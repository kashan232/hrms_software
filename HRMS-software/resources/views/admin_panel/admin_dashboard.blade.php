            ...
            <div class="row">
                ...
                {{-- <div class="col-xl-9 col-xxl-8">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <h4 class="fs-20 text-black me-4 mb-2 mt-2">Projects</h4>
                                <div class="card-header border-0 pb-0 flex-wrap">
                                    
                                    <div class="form-check custom-checkbox mb-3">
                                        <input type="checkbox" class="form-check-input" id="customCheckBox1" required>
                                        <label class="form-check-label" for="customCheckBox1">Complete Projects</label>
                                    </div>
                                    <div class="form-check custom-checkbox mb-3">
                                        <input type="checkbox" class="form-check-input" id="customCheck1" required>
                                        <label class="form-check-label" for="customCheck1">InComplete Projects</label>
                                    </div>
                                    <div class="form-check custom-checkbox mb-3">
                                        <input type="checkbox" class="form-check-input" id="customCheck2" required>
                                        <label class="form-check-label" for="customCheck2">Pending Projects</label>
                                    </div>
                                    <select class="form-control style-1 default-select mt-3 mt-sm-0" id="intervalSelect">
                                ...
                                <div class="card-body">
                                    <canvas id="projectChart" class="Project-chart"></canvas>
