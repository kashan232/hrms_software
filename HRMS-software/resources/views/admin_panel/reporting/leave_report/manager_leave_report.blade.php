                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form id="manager_leave_report" class="new-added-form" method="GET">
                                    @csrf
                                    <div class="row">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select name="Manager" id="Manager" class="form-control">
                                                ...
                                                <option value="{{ $Manager->first_name . ' ' . $Manager->last_name }}" data-id="{{ $Manager->designation }}">{{ $Manager->first_name . ' ' . $Manager->last_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-3 col-md-4">
                        ...
                        <button class="btn btn-dark ml-3 mb-3" id="generatePDF" style="font-size: 15px">
                            ...
                            <div class="table-responsive">
                                <table id="example5" class="display table-responsive-lg">
                                    ...
                                    <tbody id="manager_leave_report_append">
                                    </tbody>
                                </table>
...
<script>
    $(document).ready(function() {
        $('#manager_leave_report').on('submit', function(e) {
            ...
            $.ajax({
                url: '{{ route("get-manager-leave-report") }}', // Replace with your actual server-side endpoint URL
                method: 'GET',
                data: {
                    Manager: Manager,
                ...
                success: function(response) {
                    // Assuming you have a <tbody> element with id="manager_leave_report_append" to display the data
                    var LeaveReportTable = $('#manager_leave_report_append');
                    // Clear existing rows
...
<script>
    document.getElementById('generatePDF').addEventListener('click', function() {
        ...
        // Save the PDF
        doc.save('ManagerLeave_Report.pdf');
    });
</script>