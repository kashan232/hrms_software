                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form id="expense_report" class="new-added-form" method="GET">
                                    @csrf
                                    <div class="row">
                        ...
                        <button id="generatePdf" class="btn btn-dark ml-3 mb-3" style="font-size: 15px">Generate PDF</button>
                            ...
                            <div class="table-responsive">
                                <table id="example5" class="display table-responsive-lg">
                                    ...
                                    <tbody id="expense_report_append">
                                    </tbody>
                                    <tfoot>
                                        <tr>
...
<script>
    $(document).ready(function() {
        $('#expense_report').on('submit', function(e) {
            ...
            $.ajax({
                url: '{{ route("get-expense-report") }}', // Replace with your actual server-side endpoint URL
                method: 'GET',
                data: {
                    date_from: date_from,
                    date_to: date_to
                ...
                success: function(response) {
                    // Assuming you have a <tbody> element with id="expense_report_append" to display the data
                    var expenseReportTable = $('#expense_report_append');
...
<script>
    $(document).ready(function() {
        $('#generatePdf').on('click', function() {
            ...
            $('#expense_report_append tr').each(function(index, row) {
                const rowData = [];
