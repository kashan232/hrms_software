                                ...
                                <form action="{{ route('update-revenue',['id'=> $Revenue->id ]) }}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="number" name="amount" class="form-control" value="{{ $Revenue->amount }}">
                                        </div>

                                        <div class="mb-3 col-md-6">
                                            <label>Tax</label>
                                            <input type="number" name="tax" class="form-control" value="{{ $Revenue->tax }}">
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label>Total paid</label>
                                            <input type="number" name="total_paid" class="form-control" value="{{ $Revenue->total_paid }}">
                                        </div>
