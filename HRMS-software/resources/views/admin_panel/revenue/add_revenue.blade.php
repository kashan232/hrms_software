                                ...
                                <form action="{{ route('store-revenue') }}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="number" name="amount" class="form-control" id="amount" oninput="calculateTotal()">
                                        </div>

                                        <div class="mb-3 col-md-6">
                                            <label>Tax</label>
                                            <input type="number" name="tax" class="form-control" id="tax" oninput="calculateTotal()">
                                        </div>

                                        <div class="mb-3 col-md-6">
                                            <label>Total Paid</label>
                                            <input type="number" name="total_paid" class="form-control" id="total_paid" readonly>
                                        </div>
