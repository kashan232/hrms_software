                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example5" class="display table-responsive-lg">
                                    ...
                                    <tbody id="jobs_report_append_manager">
        ...
        $('#jobs_report_manager').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    // Assuming you have a <tbody> element with id="jobs_report_append_manager" to display the data
                    var jobsReportTable = $('#jobs_report_append_manager');
