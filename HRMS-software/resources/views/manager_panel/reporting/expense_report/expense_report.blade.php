                        ...
                        <button id="generatePdf" class="btn btn-dark ml-3 mb-3" style="font-size: 15px">Generate PDF</button>
                            ...
                            <div class="table-responsive">
                                <table id="example5" class="display table-responsive-lg">
                                    ...
                                    <tbody id="expense_report_append_manager">
        ...
        $('#expense_report_hr').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    // Assuming you have a <tbody> element with id="expense_report_append_manager" to display the data
                    var expenseReportTable = $('#expense_report_append_manager');
...
<script>
    $(document).ready(function() {
        $('#generatePdf').on('click', function() {
            ...
            pdf.setFontSize(16);
            pdf.text('Manager Expense Report', 105, 20, {
                align: 'center'
            });
            ...
            $('#expense_report_append_manager tr').each(function(index, row) {
                const rowData = [];
            ...
            // Save PDF
            pdf.save('Manager_Expense_Report.pdf');
        });
    });
</script>
