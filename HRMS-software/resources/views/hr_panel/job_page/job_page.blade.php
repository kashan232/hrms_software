                                ...
                                <form action="{{ route('store-job-page') }}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <textarea class="form-control" name="required_skills" id="requiredSkills" rows="3" placeholder="Enter required skills"></textarea>
                                        </div>
                                        <div class="mb-3 col-md-12">
                                            <label class="form-label">Educational Requirement</label>
                                            <textarea class="form-control" name="educational_requirement" id="educational_requirement" rows="3" placeholder="Enter required skills"></textarea>
                                        </div>
                                        <div class="mb-3 col-md-12">
                                            <label class="form-label">Job Description</label>
                                            <textarea class="form-control" name="job_description" id="job_description" rows="3" placeholder="Enter required skills"></textarea>
                                        </div>
                                        <div class="mb-3 col-md-4">
                                        ...
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <textarea class="form-control" name="important_notes" id="importantNotes" rows="3" placeholder="Enter important notes"></textarea>
                                        </div>
                                    </div>
