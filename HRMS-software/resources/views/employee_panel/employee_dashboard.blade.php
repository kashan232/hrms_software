...
document.addEventListener("DOMContentLoaded", function() {
    var attendanceData = [
        ...
        {{ $totalLeavechart }},
        {{ $totalAbsentchart }}
    ]; // Use dynamic data passed from the backend

    var totalAttendance = {{ $totalAttendancechart }}; // Total attendance count
    ...
    var options = {
        ...
        series: attendanceData, // Use dynamic data: Present, Leave, Absent
